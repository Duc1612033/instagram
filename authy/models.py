...
class Profile(models.Model):
    ...
    blocked_friends = models.ManyToManyField('self', symmetrical=False, related_name='blocked_by', blank=True)
    is_private = models.BooleanField(default=False)  # Trường riêng tư
